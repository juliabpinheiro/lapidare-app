...
.grupo-label{font-size:8px;letter-spacing:2px;text-transform:uppercase;color:var(--terra);font-weight:700;text-align:center;margin-bottom:2px}
.grupo-caixa{background:var(--bege);border-radius:6px;padding:6px 12px;text-align:center;font-size:9.5px;color:var(--txt);line-height:1.6}
