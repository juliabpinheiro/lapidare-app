...
export default function Personalizacao() {
  ...
  useEffect(() => {
    ...
    if (form.cor_sidebar_detail) r.style.setProperty('--sidebar-detail-color', form.cor_sidebar_detail);
        ...
        <div>
          ...
          <div className="card" style={{ padding: 18, marginBottom: 14 }}>
            ...
            {[
              ...
              { key: 'cor_sidebar_detail', label: 'Textos e detalhes do menu',   hint: 'Marca, subtítulo, rodapé, "Sair", linha divisória superior e botão <',   defaultVal: '', allowEmpty: true },
            ].map(campo => (
              <ColorRow key={campo.key} {...campo} value={form[campo.key]} onChange={v => set(campo.key, v)} />
            ))}
